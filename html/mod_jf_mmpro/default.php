...
<?php if($jf_MMPro_Panel) { ?>
	<? if ($jf_MMPro_PanelDirec  == 'left') {
		...
		<div class="lefts"><?php echo $jf_MMPro_PanelTitle; ?></div>	
		<?
	} 
	else{
		?>
		<div id="<?php echo $jf_MMPro_ID; ?>_panel" class="jf_mm_pro_panelBtn <?php echo $jf_MMPro_PanelDirec; ?>" style="<?php echo $jf_MMPro_PanelBTNStyle; ?>"><img src="/images/list_24px.png"></div><div class="rights"><?php echo $jf_MMPro_PanelTitle; ?></div>	
		<?
	}
	?>
