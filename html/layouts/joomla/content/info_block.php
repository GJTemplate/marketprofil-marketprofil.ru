...
?>
	<dl class="article-info muted tck-article-details<?php echo (TCK_ARTICLE_DETAILS_ALIGN == 1 ? ' tck-article-details-align-h' : '') ?>">
		...
		<?php if ($displayData['position'] === 'above' && ($blockPosition == 0 || $blockPosition == 2)
			...
			<dt class="article-info-term tck-article-detail-heading">
				<?php if ($displayData['params']->get('info_block_show_title', 1) && TCK_ARTICLE_DETAILS_SHOW_TITLE) : ?>
