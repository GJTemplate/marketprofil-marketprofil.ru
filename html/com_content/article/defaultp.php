...
<div class="tck-article item-page<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Article">
	...
	?>
	<div class="">
		<div class="col-md-6 float-left pdr0">
		...
		<div class="col-md-6 element-desc float-left">
			<h3 class="props-name">Параметры</h3>
			<? if(!empty($params_article['mestonakhozhdenie']['value'])){ ?><div class="row"><div class="name col-md-5"><?=$params_article['mestonakhozhdenie']['title'];?>:</div><strong class="val col-md-7"><?=$params_article['mestonakhozhdenie']['value'];?></strong></div><? } ?>
			<? if(!empty($params_article['razmery']['value'])){ ?><div class="row"><div class="name col-md-5"><?=$params_article['razmery']['title'];?>:</div><strong class="val col-md-7"><?=$params_article['razmery']['value'];?></strong></div><? } ?>
			<? if(!empty($params_article['karkas']['value'])){ ?><div class="row"><div class="name col-md-5"><?=$params_article['karkas']['title'];?>:</div><strong class="val col-md-7"><?=$params_article['karkas']['value'];?></strong></div><? } ?>
			<? if(!empty($params_article['ograzhdayushchie-konstruktsii']['value'])){ ?><div class="row"><div class="name col-md-5"><?=$params_article['ograzhdayushchie-konstruktsii']['title'];?>:</div><strong class="val col-md-7"><?=$params_article['ograzhdayushchie-konstruktsii']['value'];?></strong></div><? } ?>
			<? if(!empty($params_article['obem-postavki']['value'])){ ?><div class="row"><div class="name col-md-5"><?=$params_article['obem-postavki']['title'];?>:</div><strong class="val col-md-7"><?=$params_article['obem-postavki']['value'];?></strong></div><? } ?>
			<? if(!empty($params_article['tolshchina-metalla']['value'])){ ?><div class="row"><div class="name col-md-5"><?=$params_article['tolshchina-metalla']['title'];?>:</div><strong class="val col-md-7"><?=$params_article['tolshchina-metalla']['value'];?></strong></div><? } ?>
		</div>
	</div>
