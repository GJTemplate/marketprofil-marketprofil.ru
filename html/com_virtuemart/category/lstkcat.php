...
if (!empty($this->products)) {
	...
	echo shopFunctionsF::renderVmSubLayout('productslstk',array('products'=>$this->products,'currency'=>$this->currency,'products_per_row'=>$this->perRow,'showRating'=>$this->showRating));
