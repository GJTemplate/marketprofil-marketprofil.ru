...
if (!empty($this->products)) {
	...
	echo shopFunctionsF::renderVmSubLayout('productssend',array('products'=>$this->products,'currency'=>$this->currency,'products_per_row'=>$this->perRow,'showRating'=>$this->showRating));
