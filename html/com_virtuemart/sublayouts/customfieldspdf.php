...
<!-- 		<div class="product-fields-title-wrapper"><span class="product-fields-title"><?php echo vmText::_ ($field->custom_title) ?></span>
		...
		foreach ($product->customfieldsSorted[$position] as $field) {
			...
			?><div class="product-field product-field-type-<?php echo $field->field_type; ?> <?=$class5;?> col-md-6">
				...
				if (!empty($field->display)){
					?><div class="product-field-display"><a href="/upload/<?php echo $field->display; ?>.pdf"><img class="float-left mr-3" src="/images/pdf.png"><?php echo $field->display ?></a></div><?php
				}
