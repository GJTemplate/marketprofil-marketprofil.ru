...
<!-- 		<div class="product-fields-title-wrapper"><span class="product-fields-title"><?php echo vmText::_ ($field->custom_title) ?></span>
		...
		foreach ($product->customfieldsSorted[$position] as $field) {
			...
			?><div class="product-field product-field-type-<?php echo $field->field_type; ?> <?=$class5;?> col-md-3 float-left">
				...
				if (!empty($field->display)){
					?><div class="product-field-display "><a class="fancybox" data-fancybox="gallery" href="/images/foto-tab/<?php echo $field->display ?>"><img src="/images/foto-tab/<?php echo $field->display ?>"></a></div><?php
				}
