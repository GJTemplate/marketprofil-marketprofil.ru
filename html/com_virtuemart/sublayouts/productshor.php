...
$products_per_row = 1;
    // Show Products ?>
	<div class="product row vm-col<?php echo ' vm-col-' . $products_per_row . $show_vertical_separator ?>">
		<div class="spacer product-container" data-vm="product-container" style="width: 100%;">
			<div class="vm-product-media-container col-md-3 float-left">
            ...
            <?php die(__FILE__ .' '. __LINE__ ); ?>
				<div class=" col-md-6 float-left vm-product-descr-container-0">
...
<div class="col-md-3 float-left">
	...
	<div class="col-md-6 color_fff"><a href="<?php echo JRoute::_($product->link.$ItemidStr); ?>">Консультация</a></div>
</div>
