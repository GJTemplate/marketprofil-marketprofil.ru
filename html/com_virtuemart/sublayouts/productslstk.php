...
$products_per_row = 4;
    // Show Products ?>
	<div class="product sendv vm-col<?php echo ' vm-col-' . $products_per_row . $show_vertical_separator ?>">
		<div class="spacer product-container" data-vm="product-container">
			...
			<div class="vm3pr-<?php echo $rowsHeight[$row]['price'] ?>"> <?php
				...
				if ($product->product_packaging > 0 && $product->product_unit == 'SM') {
					?>
					<span class="ed_izm">/м<sup>2</sup></span>
					<?
				}?>
				<div class="clear"></div>
			</div>
